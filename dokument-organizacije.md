...
- Do 23.11.2025: 
    ...
    - Svaki član osmisliti svoje funkcije.
...
`mjesto`, `clan`, `clanarina`, `tip_clanarine`, `status_clanarine`, `statistika_potrosnje`, `placanje`, `racun`, `popust`, `podruznica`, `zaposlenik`, `radno_mjesto`, `odjel`, `trener_program`, `program`, `trening`, `trening_clan`, `termin_treninga`, `rezervacija`, `prostorija`, `oprema`, `odrzavanje`, `dobavljac`
...
|----------------|-------|--------------|----------|
| **Daniel Katić [Voditelj]** | Voditelj projekta + programer | **Članovi i članarine** — vođenje članova, statusi, tipovi članarina, isteci | `mjesto`, `clan`, `clanarina`, `tip_clanarine`, `status_clanarine`, `statistika_potrosnje` |
