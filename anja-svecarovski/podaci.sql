...
('Kristina', 'Božić', '15234567894', STR_TO_DATE('02.02.1990.', '%d.%m.%Y.'), 'Ž', 'Via Lungomare 6, Pula', 8, '0912233445', 'kristina.bozic@gmail.com', STR_TO_DATE('05.09.2020.', '%d.%m.%Y.'), NULL, 'aktivan', 1490.00, 1, 8),
('Ivan', 'Matić', '16234567895', STR_TO_DATE('23.06.1987.', '%d.%m.%Y.'), 'M', 'Rizzijeva 12, Pula', 8, '0983344556', 'ivan.matic@gmail.com', STR_TO_DATE('12.12.2021.', '%d.%m.%Y.'), NULL, 'aktivan', 1500.00, 1, 8),
('Tihana', 'Ćosić', '17234567896', STR_TO_DATE('30.08.1991.', '%d.%m.%Y.'), 'Ž', 'Ulica kralja Zvonimira 8, Šibenik', 9, '0914455667', 'tihana.cosic@gmail.com', STR_TO_DATE('01.02.2018.', '%d.%m.%Y.'), STR_TO_DATE('01.02.2019.', '%d.%m.%Y.'), 'neaktivan', 1500.00, 1, 9),
('Filip', 'Knežević', '18234567897', STR_TO_DATE('12.12.1983.', '%d.%m.%Y.'), 'M', 'Ulica Jakova Gotovca 3, Šibenik', 9, '0985566778', 'filip.knezevic@gmail.com', STR_TO_DATE('10.03.2019.', '%d.%m.%Y.'), NULL, 'aktivan', 1510.00, 1, 9),
('Sandra', 'Radić', '19234567898', STR_TO_DATE('04.04.1989.', '%d.%m.%Y.'), 'Ž', 'Masarykov put 7, Dubrovnik', 12, '0916677889', 'sandra.radic@gmail.com', STR_TO_DATE('20.06.2020.', '%d.%m.%Y.'), NULL, 'aktivan', 1520.00, 1, 12),
('Dino', 'Lovrić', '20234567899', STR_TO_DATE('17.09.1986.', '%d.%m.%Y.'), 'M', 'Lapadska obala 15, Dubrovnik', 12, '0987788990', 'dino.lovric@gmail.com', STR_TO_DATE('05.01.2021.', '%d.%m.%Y.'), NULL, 'aktivan', 1530.00, 1, 12),
('Ivana', 'Tadić', '21234567890', STR_TO_DATE('11.01.1992.', '%d.%m.%Y.'), 'Ž', 'Ulica Hrvatskih branitelja 4, Karlovac', 7, '0918899001', 'ivana.tadic@gmail.com', STR_TO_DATE('12.02.2019.', '%d.%m.%Y.'), NULL, 'aktivan', 1500.00, 1, 7),
('Mario', 'Bulić', '22234567891', STR_TO_DATE('29.05.1985.', '%d.%m.%Y.'), 'M', 'Trg kralja Tomislava 6, Karlovac', 7, '0989900112', 'mario.bulic@gmail.com', STR_TO_DATE('01.08.2020.', '%d.%m.%Y.'), NULL, 'aktivan', 1500.00, 1, 7),
...
('Kristina', 'Marić', '36234567895', STR_TO_DATE('14.02.1990.', '%d.%m.%Y.'), 'Ž', 'Via Lungomare 12, Pula', 8, '0984567890', 'kristina.maric@gmail.com', STR_TO_DATE('01.03.2021.', '%d.%m.%Y.'), NULL, 'aktivan', 1520.00, 1, 8),
('Davor', 'Radić', '37234567896', STR_TO_DATE('27.07.1986.', '%d.%m.%Y.'), 'M', 'Rizzijeva 14, Pula', 8, '0915678901', 'davor.radic@gmail.com', STR_TO_DATE('15.04.2020.', '%d.%m.%Y.'), NULL, 'aktivan', 1500.00, 1, 8),
('Maja', 'Novosel', '38234567897', STR_TO_DATE('11.11.1991.', '%d.%m.%Y.'), 'Ž', 'Ulica kralja Zvonimira 10, Šibenik', 9, '0986789012', 'maja.novosel@gmail.com', STR_TO_DATE('20.05.2019.', '%d.%m.%Y.'), NULL, 'aktivan', 1510.00, 1, 9),
('Filip', 'Barić', '39234567898', STR_TO_DATE('03.03.1988.', '%d.%m.%Y.'), 'M', 'Ulica Jakova Gotovca 6, Šibenik', 9, '0917890123', 'filip.baric@gmail.com', STR_TO_DATE('01.06.2020.', '%d.%m.%Y.'), NULL, 'aktivan', 1500.00, 1, 9),
('Sandra', 'Knežević', '40234567899', STR_TO_DATE('19.05.1989.', '%d.%m.%Y.'), 'Ž', 'Masarykov put 10, Dubrovnik', 12, '0988901234', 'sandra.knezevic@gmail.com', STR_TO_DATE('15.03.2021.', '%d.%m.%Y.'), NULL, 'aktivan', 1520.00, 1, 12),
('Dino', 'Horvat', '41234567890', STR_TO_DATE('28.08.1987.', '%d.%m.%Y.'), 'M', 'Lapadska obala 20, Dubrovnik', 12, '0919012345', 'dino.horvat@gmail.com', STR_TO_DATE('01.01.2020.', '%d.%m.%Y.'), NULL, 'aktivan', 1500.00, 1, 12),
('Ivana', 'Šimić', '42234567891', STR_TO_DATE('06.06.1992.', '%d.%m.%Y.'), 'Ž', 'Ulica Hrvatskih branitelja 6, Karlovac', 7, '0980123456', 'ivana.simic@gmail.com', STR_TO_DATE('10.09.2020.', '%d.%m.%Y.'), NULL, 'aktivan', 1510.00, 1, 7),
('Mario', 'Grgić', '43234567892', STR_TO_DATE('15.10.1985.', '%d.%m.%Y.'), 'M', 'Trg kralja Tomislava 10, Karlovac', 7, '0911234567', 'mario.grgic@gmail.com', STR_TO_DATE('01.06.2019.', '%d.%m.%Y.'), STR_TO_DATE('01.06.2020.', '%d.%m.%Y.'), 'neaktivan', 1500.00, 1, 7);
...
('Dino', 'Barić', '50234567899', STR_TO_DATE('09.09.1986.', '%d.%m.%Y.'), 'M', 'Via Lungomare 3, Pula', 8, '0917778899', 'dino.baric@gmail.com', STR_TO_DATE('15.02.2019.', '%d.%m.%Y.'), NULL, 'aktivan', 1200.00, 2, 8),
('Tihana', 'Novosel', '51234567890', STR_TO_DATE('23.12.1991.', '%d.%m.%Y.'), 'Ž', 'Ulica kralja Zvonimira 8, Šibenik', 9, '0988889900', 'tihana.novosel@gmail.com', STR_TO_DATE('01.03.2020.', '%d.%m.%Y.'), NULL, 'aktivan', 1200.00, 2, 9),
('Filip', 'Knežević', '52234567891', STR_TO_DATE('30.06.1989.', '%d.%m.%Y.'), 'M', 'Masarykov put 7, Dubrovnik', 12, '0919990011', 'filip.knezevic@gmail.com', STR_TO_DATE('10.06.2018.', '%d.%m.%Y.'), NULL, 'aktivan', 1200.00, 2, 12),
('Maja', 'Božić', '53234567892', STR_TO_DATE('18.05.1990.', '%d.%m.%Y.'), 'Ž', 'Trg kralja Tomislava 5, Karlovac', 7, '0980001122', 'maja.bozic@gmail.com', STR_TO_DATE('01.02.2021.', '%d.%m.%Y.'), NULL, 'aktivan', 1200.00, 2, 7);
...
('Dino', 'Novosel', '60234567899', STR_TO_DATE('05.11.1986.', '%d.%m.%Y.'), 'M', 'Via Lungomare 8, Pula', 8, '0917778890', 'dino.novosel@gmail.com', STR_TO_DATE('10.06.2018.', '%d.%m.%Y.'), NULL, 'aktivan', 1000.00, 3, 8),
('Tihana', 'Knežević', '61234567890', STR_TO_DATE('15.09.1991.', '%d.%m.%Y.'), 'Ž', 'Ulica kralja Zvonimira 12, Šibenik', 9, '0988889901', 'tihana.knezevic@gmail.com', STR_TO_DATE('01.02.2020.', '%d.%m.%Y.'), NULL, 'aktivan', 1000.00, 3, 9),
('Marko', 'Radić', '62234567891', STR_TO_DATE('18.05.1988.', '%d.%m.%Y.'), 'M', 'Masarykov put 12, Dubrovnik', 12, '0919990012', 'marko.radic@gmail.com', STR_TO_DATE('10.03.2019.', '%d.%m.%Y.'), NULL, 'aktivan', 1000.00, 3, 12),
('Lucija', 'Božić', '63234567892', STR_TO_DATE('28.08.1990.', '%d.%m.%Y.'), 'Ž', 'Trg kralja Tomislava 8, Karlovac', 7, '0980001123', 'lucija.bozic@gmail.com', STR_TO_DATE('01.04.2021.', '%d.%m.%Y.'), NULL, 'aktivan', 1000.00, 3, 7);
...
('Ivan', 'Marić', '70234567899', STR_TO_DATE('05.11.1985.', '%d.%m.%Y.'), 'M', 'Tehnička 12, Pula', 8, '0917778891', 'ivan.maric@gmail.com', STR_TO_DATE('10.06.2018.', '%d.%m.%Y.'), NULL, 'aktivan', 1600.00, 7, 8),
('Tihana', 'Novosel', '71234567890', STR_TO_DATE('15.09.1989.', '%d.%m.%Y.'), 'Ž', 'Ulica Tehničara 3, Šibenik', 9, '0988889902', 'tihana.novosel@gmail.com', STR_TO_DATE('01.02.2020.', '%d.%m.%Y.'), NULL, 'aktivan', 1600.00, 7, 9),
('Marko', 'Barić', '72234567891', STR_TO_DATE('18.05.1987.', '%d.%m.%Y.'), 'M', 'Domarska 4, Dubrovnik', 12, '0919990013', 'marko.baric@gmail.com', STR_TO_DATE('10.03.2019.', '%d.%m.%Y.'), NULL, 'aktivan', 1400.00, 8, 12),
('Ana', 'Božić', '73234567892', STR_TO_DATE('28.08.1990.', '%d.%m.%Y.'), 'Ž', 'Trg Domara 5, Karlovac', 7, '0980001124', 'ana.bozic@gmail.com', STR_TO_DATE('01.04.2021.', '%d.%m.%Y.'), NULL, 'aktivan', 1400.00, 8, 7),
...
('Ivan', 'Novosel', '80234567899', STR_TO_DATE('05.11.1987.', '%d.%m.%Y.'), 'M', 'Trg Tajnika 9, Pula', 8, '0917778892', 'ivan.novosel@gmail.com', STR_TO_DATE('10.06.2018.', '%d.%m.%Y.'), NULL, 'aktivan', 1800.00, 12, 8),
('Maja', 'Knežević', '81234567890', STR_TO_DATE('15.09.1989.', '%d.%m.%Y.'), 'Ž', 'Ulica Tajnika 2, Šibenik', 9, '0988889903', 'maja.knezevic@gmail.com', STR_TO_DATE('01.02.2020.', '%d.%m.%Y.'), NULL, 'aktivan', 1800.00, 12, 9),
('Marko', 'Barić', '82234567891', STR_TO_DATE('18.05.1986.', '%d.%m.%Y.'), 'M', 'Trg HR 4, Dubrovnik', 12, '0919990014', 'marko.baric@gmail.com', STR_TO_DATE('10.03.2019.', '%d.%m.%Y.'), NULL, 'aktivan', 2000.00, 13, 12),
('Lucija', 'Božić', '83234567892', STR_TO_DATE('28.08.1990.', '%d.%m.%Y.'), 'Ž', 'HR Ulica 6, Karlovac', 7, '0980001125', 'lucija.bozic@gmail.com', STR_TO_DATE('01.04.2021.', '%d.%m.%Y.'), NULL, 'aktivan', 2000.00, 13, 7),
...
('Ivan', 'Novosel', '90234567899', STR_TO_DATE('05.11.1988.', '%d.%m.%Y.'), 'M', 'Prodaja 9, Pula', 8, '0917778893', 'ivan.novosel@gmail.com', STR_TO_DATE('10.06.2018.', '%d.%m.%Y.'), NULL, 'aktivan', 1800.00, 17, 8),
('Maja', 'Knežević', '91234567890', STR_TO_DATE('15.09.1990.', '%d.%m.%Y.'), 'Ž', 'Prodaja 2, Šibenik', 9, '0988889904', 'maja.knezevic@gmail.com', STR_TO_DATE('01.02.2020.', '%d.%m.%Y.'), NULL, 'aktivan', 1800.00, 17, 9),
('Marko', 'Barić', '92234567891', STR_TO_DATE('18.05.1987.', '%d.%m.%Y.'), 'M', 'Dizajn 4, Dubrovnik', 12, '0919990015', 'marko.baric@gmail.com', STR_TO_DATE('10.03.2019.', '%d.%m.%Y.'), NULL, 'aktivan', 2000.00, 18, 12),
('Lucija', 'Božić', '93234567892', STR_TO_DATE('28.08.1991.', '%d.%m.%Y.'), 'Ž', 'Dizajn 6, Karlovac', 7, '0980001126', 'lucija.bozic@gmail.com', STR_TO_DATE('01.04.2021.', '%d.%m.%Y.'), NULL, 'aktivan', 2000.00, 18, 7),
...
('Ivan', 'Novosel', '100234567899', STR_TO_DATE('05.11.1988.', '%d.%m.%Y.'), 'M', 'Računovodstvo 9, Pula', 8, '0917778894', 'ivan.novosel@gmail.com', STR_TO_DATE('10.06.2019.', '%d.%m.%Y.'), NULL, 'aktivan', 2000.00, 22, 8),
('Maja', 'Knežević', '101234567890', STR_TO_DATE('15.09.1990.', '%d.%m.%Y.'), 'Ž', 'Blagajna 2, Šibenik', 9, '0988889905', 'maja.knezevic@gmail.com', STR_TO_DATE('01.02.2020.', '%d.%m.%Y.'), NULL, 'aktivan', 2000.00, 23, 9);
